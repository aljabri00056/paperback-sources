...
},{"./base":4,"./models":47}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
const GMangaSettings_1 = require("./GMangaSettings");
...
exports.GMangaInfo = {
    ...
    language: paperback_extensions_common_1.LanguageCode.SANSKRIT,
    sourceTags: [
        {
            text: 'Arabic',
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return Promise.resolve(createSection({
                ...
                rows: () => Promise.resolve([
                    (0, GMangaSettings_1.domainSettings)(this.stateManager),
                    (0, GMangaSettings_1.resetSettings)(this.stateManager)
                ])
            }));
        });
    }
...
},{"./GMangaParser":49,"./GMangaSettings":50,"paperback-extensions-common":5}],49:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    Object.defineProperty(o, k2, { enumerable: true, get: function() { return m[k]; } });
...
},{"./external/crypto-js.min.js":51,"lodash":1,"paperback-extensions-common":5}],50:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.resetSettings = exports.domainSettings = exports.BackupDomain = exports.getDomain = void 0;
const getDomain = (stateManager) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    return ((_a = (yield stateManager.retrieve('domain'))) !== null && _a !== void 0 ? _a : yield stateManager.retrieve('default_domain'));
});
exports.getDomain = getDomain;
const BackupDomain = (stateManager) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    return (_b = (yield stateManager.retrieve('backup_domain'))) !== null && _b !== void 0 ? _b : false;
});
exports.BackupDomain = BackupDomain;
                    ...
                    createSection({
                        ...
                        rows: () => {
                            return Promise.all([
                                ...
                                (0, exports.BackupDomain)(stateManager)
