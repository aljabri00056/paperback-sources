...
exports.ComicKInfo = {
    ...
    version: "0.1.0",
    description: "Extension that scrapes comics from ComicK.io.",
    author: "Nouun",
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (pages > 0) {
                const reqs = [...Array(pages).keys()]
                    ...
                    const req = createRequestObject({
                        url: `${API_BASE_URL}/comic/${_res.hid}/chapters?tachiyomi=true&page=${page + 1}`,
                        method: "GET",
                    });
                    const res = yield this.requestManager.schedule(req, 2);
                    const data = JSON.parse(res.data);
...
},{"./ComicKHelper":48,"./ComicKParser":49,"./ComicKSettings":50,"paperback-extensions-common":4}],48:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
